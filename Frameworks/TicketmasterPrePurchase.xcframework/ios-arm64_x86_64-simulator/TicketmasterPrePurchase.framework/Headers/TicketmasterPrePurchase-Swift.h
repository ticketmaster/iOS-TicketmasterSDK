...
#ifndef TICKETMASTERPREPURCHASE_SWIFT_H
#define TICKETMASTERPREPURCHASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TicketmasterPrePurchase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)changeLocationWithCoordinate:(CLLocationCoordinate2D)coordinate;
- (void)communicateLocationFetchError;
...
@interface TMPrePurchaseViewController (SWIFT_EXTENSION(TicketmasterPrePurchase)) <UALWebViewMessageHandlerDelegate>
