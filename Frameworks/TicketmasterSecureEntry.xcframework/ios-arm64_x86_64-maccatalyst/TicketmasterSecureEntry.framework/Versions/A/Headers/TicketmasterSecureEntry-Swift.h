...
#ifndef TICKETMASTERSECUREENTRY_SWIFT_H
#define TICKETMASTERSECUREENTRY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TicketmasterSecureEntry",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC23TicketmasterSecureEntry15SecureEntryView")
@interface SecureEntryView : UIView
/// Subtitle for the PDF417 variant of the SafeTix ticket.
/// The default value for this property is <em>“Screenshots won’t get you in.”</em>.
/// note:
///
/// Set an <em>empty</em> string to hide subtitle.
@property (nonatomic, copy) IBInspectable NSString * _Nonnull pdf417Subtitle;
/// Error message to display in case of invalid token
/// The default value for this property is <em>“Reload ticket”</em>.
@property (nonatomic, copy) IBInspectable NSString * _Nonnull errorMessage;
