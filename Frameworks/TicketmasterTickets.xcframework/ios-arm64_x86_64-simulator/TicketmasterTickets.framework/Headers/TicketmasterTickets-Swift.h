...
#ifndef TICKETMASTERTICKETS_SWIFT_H
#define TICKETMASTERTICKETS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TicketmasterTickets",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcode
SWIFT_CLASS("_TtC19TicketmasterTickets9TMTickets")
@interface TMTickets : NSObject
...
/// //   * 2D barcodes
/// //   * videos
/// let headerView = TMModuleHeaderView.build()
///
/// // multiple configure(...) methods are available
/// //  we will use the one for background images
/// headerView.configure(backgroundImage: backgroundImage)
///
/// // build header display
/// //  any UIView will work here for headerView, not just a TMModuleHeaderView
...
///                        actionButtons: [actionButton]) // you can show 0 to 3 buttons
///
/// \endcode
SWIFT_CLASS("_TtC19TicketmasterTickets15TMTicketsModule")
@interface TMTicketsModule : NSObject
...
///
/// \endcode
SWIFT_CLASS("_TtC19TicketmasterTickets25TMTicketsModuleHeaderView")
@interface TMTicketsModuleHeaderView : UIView
...
/// use to render Tickets SDK as a UIView embedded inside of your own UIViewController
/// Note that this will only apply to the My Events page, as additional UI (like My Tickets) are presented modally on top of the current UIViewController.
/// important:
/// For most UI designs, it may be easier for you to use a <code>TMTicketsViewController</code> instead of this class
SWIFT_CLASS("_TtC19TicketmasterTickets13TMTicketsView")
@interface TMTicketsView : UIView
...
/// this class wraps the <code>TMTicketsView</code> in a <code>UIViewController</code> for ease of use
/// This is the recommended way to present the Tickets SDK.
/// note:
/// This class tries to add a <code>Logout</code> button to the top-right of the <code>UINavigationBar</code>.
/// Disable this behavior if needed by setting <code>TMTicketsViewController/addLogoutButton</code> to <code>false</code>.
/// Override the default “My Tickets” title by setting the <code>title</code> property.
/// \code
/// let ticketsVC = TMTicketsViewController()
/// ticketsVC.addLogoutButton = false // default: true
/// ticketsVC.title = "Custom Title"  // default: "My Tickets"
///
...
///
/// \endcode
SWIFT_CLASS("_TtC19TicketmasterTickets23TMTicketsViewController")
@interface TMTicketsViewController : UIViewController
